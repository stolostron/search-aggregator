...
func ChunkedInsertEdge(resources []Edge) ChunkedOperationResult {
	...
	newWhereClause := true //boolean to check if whereClause is new and not sent to redisgraph yet
	...
	if newWhereClause { //indicates edges are not yet inserted into redisgraph
